...
def isAnswerCorrect(question, answer):
    ...
    return True if QUESTIONS[question]["answer"]==answer  else False      #remove this
...
def kbc():
    ...
    while game_play and i<15:
        ...
        if isAnswerCorrect(i, int(ans) ):
            ...
            # end the game now.
            print("OOps!! YOUR ANSWER IS INCORRECT , the correct answer is",QUESTIONS[i]['answer'])           
